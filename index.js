...
const UUID = process.env.UUID || 'ac4ed27d-f6ef-462b-b48a-69caad0cb35b';
...
const DOMAIN = process.env.DOMAIN || 'rs00181946.oners.jp';
const AUTO_ACCESS = process.env.AUTO_ACCESS || true;
const WSPATH = process.env.WSPATH || UUID.slice(0, 8);
const SUB_PATH = process.env.SUB_PATH || 'sub';
const NAME = process.env.NAME || 'Value-JP';
const PORT = process.env.PORT || 55218;
